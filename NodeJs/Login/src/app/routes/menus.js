...
const { getItems, getItem, createItem, deleteItem, updateItem, getMenuUser } = require('../controlles/menus')
...
router.delete('/:_id', checkAuth, deleteItem)
// get items menus user
//router.get('/', checkAuth, getItems)
router.post('/user',checkAuth, getMenuUser)
//Filter 
