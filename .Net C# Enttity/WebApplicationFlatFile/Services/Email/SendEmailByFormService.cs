...
using WebApplicationFlatFile.Resx;
...
namespace WebApplicationFlatFile.Services.Email
{
    public class SendEmailByFormService: ISendEmailByFormService
    {
        ...
        public Task<(bool succeeded, string message)> SendEmailReportA(string idUser, string body, string affair, string fileAddName, CancellationToken ct)
        {
            throw new NotImplementedException();
        }

        public Task<(bool succeeded, string message)> SendEmailReturns(int idCompany, int idAdmForm, AdmEmployeeEntity admEmployee, string idUser, string nameEquipment, List<string> subApplicationName, List<string> typeEquipmentApplicationName, string fileAddName, string typeReturn, CancellationToken ct)
        {
            throw new NotImplementedException();
        }
    }
